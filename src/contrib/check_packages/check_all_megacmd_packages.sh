...
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL DEBIAN_9;$BASEURLDEB/Debian_9.0"
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL DEBIAN_9_i386_T;$BASEURLDEB/Debian_9.0"
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL DEBIAN_10;$BASEURLDEB/Debian_10.0"
...
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL FEDORA_28;$BASEURLRPM/Fedora_28"
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL FEDORA_29;$BASEURLRPM/Fedora_29 "
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL FEDORA_30;$BASEURLRPM/Fedora_30 "
...
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL OPENSUSE_LEAP_15;$BASEURLRPM/openSUSE_Leap_15.0"
...
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL UBUNTU_18.04;$BASEURLDEB/xUbuntu_18.04"
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL UBUNTU_19.04;$BASEURLDEB/xUbuntu_19.04"
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL UBUNTU_18.10;$BASEURLDEB/xUbuntu_18.10"
...
count=0
tot=`echo $PAIRSVMNAMEREPOURL | wc -w`
for i in `shuf -e $PAIRSVMNAMEREPOURL`; do
	...
	count=$((count + 1))
	echo "Starting check of $i : $count out of $tot"
